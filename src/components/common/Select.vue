<template>
    <div
        class="flex p-2 bg-white text-slate-600 placeholder-slate-300 shadow-sm border rounded-md text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">
        ...
        <tippy class="w-0" ref="dropdown" trigger="click" placement="bottom-end" :offset="[0, 10]" animation="fade" :interactive="true" :arrow="false">
            ...
            <template #content>
                <div class="p-2 bg-white shadow-xl rounded">
