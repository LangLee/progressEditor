<template>
    <div class="w-full flex flex-row items-center justify-center bg-slate-300/20 text-gray-500 p-2 rounded-lg">
        ...
        <div class="flex-1">
            ...
            <div class="text-sm text-gray-400">{{ modelValue || placeholder }}</div>
        </div>
        <button class="px-2 rounded border border-gray-300 text-gray-700 hover:border-blue-500 hover:text-blue-500 text-sm" @click="onBind">{{ operation }}</button>
