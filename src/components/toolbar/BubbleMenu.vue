<template>
  ...
  >
    ...
    >
      <template #title>
        <RemixIcon
          class="mr-1 text-purple-500 dark:text-purple-300"
          name="robot-2-line"
        ></RemixIcon>
      ...
      <template #item="{ item }">
        <div
          ...
          :class="{
            'bg-neutral-200 dark:bg-neutral-600': editor.isActive('heading', {
              level: item.level,
            }),
          }"
        >
    ...
    >
      ...
      <template #item="{ item }">
        <div
          ...
          :class="{
            'bg-neutral-200 dark:bg-neutral-600': editor.isActive(item.value),
          }"
        >
          <RemixIcon :name="item.icon" />
          <span class="ml-2">{{ item.label }}</span>
    ...
    >
      ...
      <template #item="{ item }">
        <div
          ...
          :class="{
            'bg-neutral-200 dark:bg-neutral-600': editor.isActive({
    ...
    <div
      ...
      :class="{
        'bg-neutral-200 dark:bg-neutral-600': editor.isActive('italic'),
      }"
    >
    ...
    <div
      ...
      :class="{
        'bg-neutral-200 dark:bg-neutral-600': editor.isActive('underline'),
      }"
    >
    ...
    <div
      ...
      :class="{
        'bg-neutral-200 dark:bg-neutral-600': editor.isActive('strike'),
      }"
    >
    ...
    >
      <div
        class="mx-1 px-2 py-1 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-500 cursor-pointer"
        :class="{
          'bg-neutral-200 dark:bg-neutral-600': editor.isActive('link'),
        }"
      >
        <RemixIcon name="link" />
      </div>
      <template #content>
        <div class="flex flex-row">
          ...
          <button
            class="w-full px-2 my-1 rounded-lg bg-purple-500 text-white"
            @click="setLink"
          >
            set
          </button>
    ...
    <div
      ...
      :class="{
        'bg-neutral-200 dark:bg-neutral-600': editor.isActive('paragraph'),
      }"
    >
    ...
    <div
      ...
      :class="{
        'bg-neutral-200 dark:bg-neutral-600': editor.isActive('codeBlock'),
      }"
    >
...
import {
  isCellSelection,
  isTextSelected,
} from '@/components/editor/extend/utils'
...
const onTranslate = () => {
  ...
  getYouDaoAiTranslate({
    query: text,
    from: isEnglish ? 'en' : 'zh-CHS',
    to: isEnglish ? 'zh-CHS' : 'en',
  }).then((data) => {
...
const handleAIWrite = (key) => {
  ...
  switch (key) {
    case 'simplify':
      prompt =
        '将以下文本简化为更易懂的表达方式，尽量使用简单的词汇和短句，同时保持原意不变。'
      break
    case 'translate':
