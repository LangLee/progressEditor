    ...
    <div class="h-screen flex flex-col items-center justify-center lg:bg-slate-300/20 p-4">
        <div class="w-full lg:w-96 flex flex-col bg-white p-8 rounded-md lg:shadow-md">
            ...
            <div class="flex flex-row justify-between mt-4">
                <button class="h-8 rounded-full px-4 text-sm text-white bg-slate-500 hover:bg-slate-300" @click="toggleMode()">
                    <RemixIcon class="text-white mr-1" :name="loginMode === 1?'smartphone-line':'user-line'"></RemixIcon>
